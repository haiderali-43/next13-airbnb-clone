  ...
  return (
    <div className="w-full relative">
      {formatPrice && (
        <BiDollar
          size={20}
          className="absolute top-[1.8rem] left-2 text-neutral-700"
        />
      )}
      <input
        id={id}
        ...
        placeholder=" "
        type={type}
        className={`peer w-full px-4 p-4 pt-6 font-semibold text-[18px] bg-white border-2 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed
